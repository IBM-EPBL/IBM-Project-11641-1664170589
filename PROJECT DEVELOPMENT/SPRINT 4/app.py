...
def predict():
    if request.method == "POST":
        ...
        loan_amount = request.form['loanAmtBox']
        loan_amount_term = request.form['loanAmtTermBox']
        ...
        if prediction == 'Y':
            prediction = "Congrats , You are eligible to apply for loan"
        else:
            prediction = "Sorry , You are ineligible to apply for loan"
